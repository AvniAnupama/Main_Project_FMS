...
var department_name= formData.get("department_name");
                $.ajax({
                    url: FormAction,
                    type: 'POST',
                    data: formData,
                    ...
                    success: function (res) {
						...
						table.row.add([AddIndexIncrement,department_name,edit,Tdelete]).draw();
						}
						else{
...
function UserDelete(val,index) {
		...
		type: "POST",
		url: FormAction,
		data:{'manage_employee_department_id':val},
		success: function(res){
			if(res == "1"){
