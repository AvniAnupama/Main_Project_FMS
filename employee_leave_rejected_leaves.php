            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"><?=ucwords('Rejected Leaves');?></a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
...
<th>end date</th>
											...
											{
													$formDataFull=$obj->select_any("tbl_employee_leave_leave_application","employee=".$_SESSION['user_id']." and status=2 order by employee_leave_leave_application_id DESC");
											}
											else
											{
											$formDataFull=$obj->select_any("tbl_employee_leave_leave_application","status=2 order by employee_leave_leave_application_id DESC");
											}
											$count=1;
