        ...
        <div class="content-body">
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">**itemName**</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
            ...
            <div class="container-fluid">
				...
				<?php
						...
						{
						?>
						<div class="col-lg-3 col-sm-6" onclick="location.href='Pages?module=**itemName**'">
					...
					$page_data=$obj->select_any_one("tbl_pages","module='**itemName**'");
					if($page_data['pages']!='' ||$page_data['pages']=='[]')
					{
					$Module_Name=str_replace(" ","_","**itemName**");
