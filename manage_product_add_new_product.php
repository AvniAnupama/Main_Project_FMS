<?php
/***************************************************************************
* File name   : manage_product_add_new_product.php
* Begin       : 15 April 2021
* Author: Anupama A
***************************************************************************/
...
if(isset($_GET['flag']))
{
include_once"../manage product/manage_product_add_new_product_all.php";//content
}
else
{
include_once"../manage product/manage_product_add_new_product.php";//content
