...
var damaged_items= formData.get("damaged_items");
var total_damaged_items= formData.get("total_damaged_items");
var damage_entry_date= formData.get("damage_entry_date");
                $.ajax({
                    url: FormAction,
                    type: 'POST',
                    data: formData,
                    ...
                    success: function (res) {
						...
						table.row.add([AddIndexIncrement,product,damaged_items,total_damaged_items,damage_entry_date,edit,Tdelete]).draw();
						}
						else{
...
function UserDelete(val,index) {
		...
		type: "POST",
		url: FormAction,
		data:{'damage_entry_manage_damage_id':val},
		success: function(res){
			if(res == "1"){
...
function setStock(val)
{
	...
	$.ajax({
		type: "POST",
		url: '../damage entry/Action/Actiondamage_entry_manage_damage.php',
